...
function test() {
  ...
  let answer1 = "1. To repeat a statement multiple times.";
  let answer2 = "2. To decompose a program into several small subroutines.";
  let answer3 = "3. To determine the execution time of a program.";
  let answer4 = "4. To interrupt the execution of a program.";
  let rightAnswer = input(answer2);
